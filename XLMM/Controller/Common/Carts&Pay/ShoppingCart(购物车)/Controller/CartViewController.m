...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0) {
        ...
        if (self.dataArray.count == 0) {
            ...
            [cell.myImageView sd_setImageWithURL:[NSURL URLWithString:[[model.pic_path imageGoodsOrderCompression] JMUrlEncodedString]]];
    ...
    } else if (indexPath.section == 1)
    {
        ...
        if (self.historyCarts.count == 0) {
            ...
            [cell.headImageView sd_setImageWithURL:[NSURL URLWithString:[[model.pic_path imageGoodsOrderCompression] JMUrlEncodedString]]];
