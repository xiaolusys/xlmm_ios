...
- (void)registerWkwebviewJsBridge:(WKWebViewConfiguration*) configuration{
     ...
     */
    [configuration.userContentController addScriptMessageHandler:self name:@"callNativeUniShareFunc"];
    /**
     *   进入购物车  -- 判断是否登录
     */
    [configuration.userContentController addScriptMessageHandler:self name:@"jumpToNativeLogin"];
    
    [configuration.userContentController addScriptMessageHandler:self name:@"getNativeMobileSNCode"];
