...
@property (nonatomic, strong) NSNumber *remain_num;
@property (nonatomic, strong) NSNumber *shop_product_num;
@property (nonatomic, strong) NSString *rebet_amount_des;
@property (nonatomic, strong) NSString *sale_num_des;
