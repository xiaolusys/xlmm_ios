//
//  UICollectionView+CSCollectionViewPlaceHolder.m
//  XLMM
//
...
@implementation UICollectionView (CSCollectionViewPlaceHolder)
...
- (void)cs_checkEmpty {
    ...
    if (!isEmpty != !self.placeHolderView) {
        if (isEmpty) {
            ...
            if ([self respondsToSelector:@selector(createPlaceHolderView)]) {
                self.placeHolderView = [self performSelector:@selector(createPlaceHolderView)];
            } else if ( [self.delegate respondsToSelector:@selector(createPlaceHolderView)]) {
                self.placeHolderView = [self.delegate performSelector:@selector(createPlaceHolderView)];
            } else {
